...
public class CheckPackage extends JFrame{
    ...
    CheckPackage(){
        ...
        String[] package3 = {"BRONZE PACKAGE", "5 Days and 5 Nights" ,"Return Airfare", "Free Clubbing, Horse Riding & other Games" ,"River Rafting","Hard Drink Free", "Daily Buffet", "BBQ Dinner", "Book Now", "WINTER SPECIAL", "Rs 32000/-", "package3.jpg "};
